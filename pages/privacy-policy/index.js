    ...
    <Container>
      ...
      <TextContainer>
        ...
        <p>
          ...
          of the AirTV sh.p.k.. The use of the Internet pages of AirTV sh.p.k.
          ...
          country-specific data protection regulations applicable to AirTV
          sh.p.k.. By means of this data protection declaration, our enterprise
          ...
          declaration, of the rights to which they are entitled. As the
          controller, AirTV sh.p.k. has implemented numerous technical and
          organizational measures to ensure the most complete protection of
          personal data processed through the app and/or website. However,
        ...
        <h2>1. Definitions</h2>
        <p>
          The data protection declaration of AirTV sh.p.k. is based on the terms
          ...
          declaration, we use the following terms:
        </p>
        ...
        <p>
          ...
          the processing of that data by those public authorities shall be in
        ...
        <p>
          ...
          authorized to process personal data. k) Consent Consent of the data
        ...
        <p>
          ...
          AirTV sh.p.k. Prishtina, KOSOVO Phone: 0049 173 533 8322 email:
          support@airtv.live Website: https://www.airtv.live
        </p>
        <h2>3. Cookies</h2>
        <p>
          The Internet pages of the AirTV sh.p.k. use cookies. Cookies are text
          ...
          cookie is stored. This allows visited Internet sites and servers to
          ...
          Through the use of cookies, the AirTV sh.p.k. can provide the users of
          the website with more user-friendly services that would not be
          possible without the cookie setting. By means of a cookie, the
          information and offers on our website can be optimized with the user
          in mind. Cookies allow us, as previously mentioned, to recognize our
          website users. The purpose of this recognition is to make it easier
          for users to utilize our website. The website user that uses cookies,
          ...
          thus stored on the user’s computer system. Another example is the
          cookie of a shopping cart in an online shop. The online store
          remembers the articles that a customer has placed in the virtual
          shopping cart via a cookie. The data subject may, at any time, prevent
          the setting of cookies through our website by means of a corresponding
          setting of the Internet browser used, and may thus permanently deny
          the setting of cookies. Furthermore, already set cookies may be
          deleted at any time via an Internet browser or other software
          programs. This is possible in all popular Internet browsers. If the
          data subject deactivates the setting of cookies in the Internet
          browser used, not all functions of our website may be entirely usable.
        </p>
        <h2>4. Collection of general data and information</h2>
        <p>
          The website of the AirTV sh.p.k. collects a series of general data and
          ...
          attacks on our information technology systems. When using these
          general data and information, the AirTV sh.p.k. does not draw any
          ...
          cyber-attack. Therefore, the AirTV sh.p.k. analyzes anonymously
        ...
        <p>
          ...
          the controller. By registering on the website of the controller, the
          IP address—assigned by the Internet service provider (ISP) and used by
          the data subject—date, and time of registration are also stored. The
          storage of this data takes place against the background that this is
          ...
          storage of this data is necessary to secure the controller. This data
          is not passed on to third parties unless there is a statutory
          obligation to pass on the data, or if the transfer serves the aim of
          criminal prosecution. The registration of the data subject, with the
          voluntary indication of personal data, is intended to enable the
          controller to offer the data subject contents or services that may
          only be offered to registered users due to the nature of the matter in
          ...
          each data subject as to what personal data is stored about the data
          subject. In addition, the data controller shall correct or erase
          personal data at the request or indication of the data subject,
          insofar as there are no statutory storage obligations. A Data
          Protection Officer particularly designated in this data protection
          declaration, as well as the entirety of the controller’s employees are
          available to the data subject in this respect as contact persons.
        </p>
        <h2>6. Contact possibility via the website</h2>
        <p>
          The website of the AirTV sh.p.k. contains information that enables a
          ...
          the controller by email or via a contact form, the personal data
        ...
        <p>
          ...
          confirmation, he or she may, at any time, contact our Data Protection
        ...
        <p>
          ...
          subject access to the following information: ● the purposes of the
          ...
          or international organizations. ● where possible, the envisaged period
          ...
          as to whether personal data are transferred to a third country or an
          international organization. Where this is the case, the data subject
          shall have the right to be informed of the appropriate safeguards
          relating to the transfer. If a data subject wishes to avail himself of
          this right of access, he or she may at any time contact our Data
        ...
        <p>
          ...
          the purposes for which they were collected or otherwise processed. The
          ...
          for the processing. The data subject objects to the processing
          ...
          the processing pursuant to Article 21 (2) of the GDPR. The personal
          data have been unlawfully processed. The personal data must be erased
          for compliance with a legal obligation in Union or Member State law to
          ...
          applies, and a data subject wishes to request the erasure of personal
          data stored by the AirTV sh.p.k., he or she may at any time contact
          our Data Protection Officer or another employee of the controller. The
          Data Protection Officer of the AirTV sh.p.k. or another employee shall
          promptly ensure that the erasure request is complied immediately.
          ...
          required. The Data Protection Officer of the AirTV sh.p.k. or another
        ...
        <p>
          ...
          where one of the following applies: The accuracy of the personal data
          is contested by the data subject, for a period enabling the controller
          to verify the accuracy of the personal data. The processing is
          unlawful and the data subject opposes the erasure of the personal data
          and requests the restriction of their use instead. The controller no
          longer needs the personal data for the purposes of the processing, but
          they are required by the data subject for the establishment, exercise
          or defense of legal claims. The data subject has objected to
          ...
          those of the data subject. If one of the aforementioned conditions are
          met and a data subject wishes to request the restriction of the
          processing of personal data stored by the AirTV sh.p.k., he or she may
          at any time contact our Data Protection Officer or another employee of
          the controller. The Data Protection Officer of the AirTV sh.p.k. or
        ...
        <p>
          ...
          of the GDPR or point (a) of Article 9 (2) of the GDPR, or on a
          ...
          in the controller Furthermore, in exercising his or her right to data
          ...
          any time contact the Data Protection Officer designated by the AirTV
          sh.p.k. or another employee.
        </p>
        ...
        <p>
          ...
          GDPR. This also applies to profiling based on these provisions. The
          AirTV sh.p.k. shall no longer process the personal data in the event
          ...
          defense of legal claims. If the AirTV sh.p.k. processes personal data
          for direct marketing purposes, the data subject shall have the right
          to object at any time to processing of personal data concerning him or
          her for such marketing. This applies to profiling to the extent that
          it is related to such direct marketing. If the data subject objects to
          the AirTV sh.p.k. to the processing for direct marketing purposes, the
          AirTV sh.p.k. will no longer process the personal data for these
          purposes. In addition, the data subject has the right, on grounds
          relating to his or her particular situation, to object to the
          processing of personal data concerning him or her by the AirTV sh.p.k.
          ...
          subject may directly contact the Data Protection Officer of the AirTV
          sh.p.k. or another employee. In addition, the data subject is free in
        ...
        <p>
          ...
          or the performance of, a contract between the data subject and the
          data controller, or (2) it is based on the data subject’s explicit
          consent, the AirTV sh.p.k. shall implement suitable measures to
          ...
          directly contact our Data Protection Officer of the AirTV sh.p.k. or
          another employee of the controller. i) Right to withdraw data
          protection consent Each data subject shall have the right granted by
          the European legislator to withdraw his or her consent to the
          processing of his or her personal data at any time. If the data
          subject wishes to exercise the right to withdraw the consent, he or
          she may at any time directly contact our Data Protection Officer of
          the AirTV sh.p.k. or another employee of the controller
        </p>
        ...
        <p>
          ...
          for the fulfillment of tax obligations, the processing is based on
          Art. 6 (1) lit. c GDPR. In rare cases, the processing of personal data
        ...
        <p>
          ...
          provided by the data subject, the data subject must contact our Data
          Protection Officer. Our Data Protection Officer clarifies to the data
          subject whether the provision of the personal data is required by law
          or contract or is necessary for the conclusion of the contract,
        ...
        <p>
          ...
          Policy Generator of the External Data Protection Officer from DGD
          Deutsche Gesellschaft für Datenschutz GmbH, which has been developed
          in cooperation with WILDE BEUGER SOLMECKE | Lawyers and the used
          hardware dealer RC GmbH.
        </p>
        <h2>14. Privacy Policy Changes</h2>
        <p>
          Although most changes are likely to be minor, AirTV sh.p.k.may change
          its Privacy Policy from time to time, and in AirTV sh.p.k. sole
          discretion. AirTV sh.p.k. encourages visitors to frequently check this
